...
window.addEventListener('scroll',changevalueonScroll)
    ...
    <div id="section-1" className='app-aboutme-description'>
      <div>
      <h1  className={state?"onvisibleSlideRight app-mainh1":"invisible app-mainh1"} >{props.title}</h1>
         <p className={state?"onvisibleSlideUp":"invisible"}>{props.corpo}</p>
         <p className={state?"onvisibleSlideUp":"invisible"}>{props.corpo2}</p>
         </div>
